...
tests_ExpNew tc = 
  ...
  where me = Map.empty
        new = New ()
        ctea = Map.insert "A" (CT "A" "" [] me me []) me
        fB = Map.insert "f" (TRef TInt) me
        fC = Map.insert "g" (TRef TBool) me
...
tests_IsWellFormed tc =
  [
    ...
    testCase "IWF5.0" $ testTC tc $ p [(cd "A" "Object" [] []),(cd "B" "A" [] [])],
    testCase "IWF5.1" $ testTC tc $ p [(cd "A" "Object" [] []),(cd "B" "A" [(fd "bool" "f")] [])],
    testCase "IWF5.2" $ testTC tc $ p [(cd "A" "Object" [] []),(cd "B" "A" [] [(md "int" "m" [] noop)])],
    testCase "IWF5.3" $ testTC tc $ p [(cd "A" "Object" [] []),(cd "B" "A" [(fd "bool" "f")] [(md "int" "m" [] noop)])],
    testCase "IWF5.4" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] []),(cd "B" "A" [(fd "bool" "f")] [])],
    testCase "IWF5.5" $ testTC tc $ p [(cd "A" "Object" [] [(md "int" "h" [] noop)]),(cd "B" "A" [(fd "bool" "f")] [])],
    testCase "IWF5.6" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] [(md "int" "h" [] noop)]),(cd "B" "A" [(fd "bool" "f")] [])],
    testCase "IWF5.7" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] []),(cd "B" "A" [] [(md "int" "m" [] noop)])],
    testCase "IWF5.8" $ testTC tc $ p [(cd "A" "Object" [] [(md "int" "h" [] noop)]),(cd "B" "A" [] [(md "int" "m" [] noop)])],
    testCase "IWF5.9" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] [(md "int" "h" [] noop)]),(cd "B" "A" [] [(md "int" "m" [] noop)])],
    testCase "IWF5.10" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] []),(cd "B" "A" [(fd "bool" "f")] [(md "int" "m" [] noop)])],
    testCase "IWF5.11" $ testTC tc $ p [(cd "A" "Object" [] [(md "int" "h" [] noop)]),(cd "B" "A" [(fd "bool" "f")] [(md "int" "m" [] noop)])],
    testCase "IWF5.12" $ testTC tc $ p [(cd "A" "Object" [(fd "int" "g")] [(md "int" "h" [] noop)]),(cd "B" "A" [(fd "bool" "f")] [(md "int" "m" [] noop)])],
